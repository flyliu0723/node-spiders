...
var i = 0;
var pa = 100;
var url = "http://www.sduod.com/study/info_100.html";
//初始url
...
function savedImg($,news_title) {
    ...
    //采用request模块，向服务器发起一次请求，获取图片资源
        ...
        request(img_src).pipe(fs.createWriteStream('./images/'+news_title + '---' + img_filename));     //通过流的方式，把图片写到本地/image目录下，并用新闻的标题和图片的标题作为图片的名称。
    })
}
